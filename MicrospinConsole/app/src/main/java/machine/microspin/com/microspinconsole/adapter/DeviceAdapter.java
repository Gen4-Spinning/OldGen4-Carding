package machine.microspin.com.microspinconsole.adapter;
...
/**
 * Adapter for the List View showing the list of discovered Bluetooth Devices nearby.
 * Device Properties Displayed:
 * ---> Device Name
 * ---> Device Address
 * ---> Device Paired Status
 */
